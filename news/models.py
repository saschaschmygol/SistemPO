...
class Profiles(models.Model):
    ...
    land = models.CharField(max_length=255, verbose_name="Страна", blank=True, null=True)
    age = models.IntegerField(max_length=10, verbose_name="Возраст", blank=True, null=True)
